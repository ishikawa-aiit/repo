    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":".","files":"**/*.stories.mdx","importPathMatcher":"^\\.(?:(?:^|\\/|(?:(?:(?!(?:^|\\/)\\.).)*?)\\/)(?!\\.)(?=.)[^/]*?\\.stories\\.mdx)$"},{"titlePrefix":"","directory":".","files":"**/*.stories.@(ts|tsx)","importPathMatcher":"^\\.(?:(?:^|\\/|(?:(?:(?!(?:^|\\/)\\.).)*?)\\/)(?!\\.)(?=.)[^/]*?\\.stories\\.(ts|tsx))$"}];
          
      
          
            window['SERVER_CHANNEL_URL'] = "ws://localhost:3001/storybook-server-channel";</script><script src="runtime~main.iframe.bundle.js"></script><script src="vendors-node_modules_chakra-ui_react_dist_chakra-ui-react_esm_js-node_modules_emotion_react_j-b4f5d8.iframe.bundle.js"></script><script src="main.iframe.bundle.js"></script></body></html>